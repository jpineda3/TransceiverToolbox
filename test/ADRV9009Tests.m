classdef ADRV9009Tests < HardwareTests
    ...
    properties (TestParameter)
        attribute_single_value = {
            ...
            {'rx', 'GainChannel0', 'Double', 'voltage0', false, 'hardwaregain', -5, 30, 0.5, 0, 20}; % setting large negative gain is accepted but writes positive value
            {'rx', 'GainChannel1', 'Double', 'voltage1', false, 'hardwaregain', -5, 30, 0.5, 0, 20};
